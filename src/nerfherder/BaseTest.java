...
public class BaseTest {
	...
	public HashMap<String, String> generateCreditCard() {
		final HashMap<String, String> newCard = new HashMap<String, String>();
	...
	public HashMap<String, String> generatePerson() {
		final HashMap<String, String> newPerson = new HashMap<String, String>();
		newPerson.put("first", "Matthew");
		newPerson.put("last", "Meling");
		newPerson.put("name", "Matthew Meling");
